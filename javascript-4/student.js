...
var faveColors = ["blue", "black", "grey"]
// CODE HERE
...
var me = {
    firstName: "Leo",
    superHeroName: "codeBae",
    homeTown: "Neptune",
    superPowers: ["invisibility", "visibility", "anxiousness"],
...
function setColor(arr){
    arr.splice(3, faveColors.length - 3)
for (let i=0; i < arr.length; i++){
    if (faveColors[i] == "blue"){
        faveColors[i] = "#4D4DFF"
    }}
background("blue", "black", "grey")
}
// CODE HERE
