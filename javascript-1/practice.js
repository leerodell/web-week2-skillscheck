...
var doubled = myNumbers.map(function(arr){
	return arr * 2;
})
...
myNumbers.forEach(function (value, i) {
...
let enemies = people.filter(function(boolean){
	return boolean.friend == false
})
// Code Here
...
var totallyAwesome = people.map(function(a) {return a.awesomeLevel})
